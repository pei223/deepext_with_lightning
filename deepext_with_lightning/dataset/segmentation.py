...
class IndexImageDataset(Dataset):
    @staticmethod
    def create(image_dir_path: str, index_image_dir_path: str, transforms: Optional[Callable],
    ...
    def __init__(self, image_filename_ls: List[Path], image_dir: str, index_image_dir: str,
