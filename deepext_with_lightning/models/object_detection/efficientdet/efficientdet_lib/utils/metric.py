...
def _get_detections(dataset, model, score_threshold=0.05, max_detections=100, save_path=None):
    ...
    # Arguments
        dataset         : The generator used to run image_process through the retinanet.
        retinanet           : The retinanet to run on the image_process.
        score_threshold : The score confidence threshold to use.
        max_detections  : The maximum number of detections to use per image.
        save_path       : The path to save the image_process with visualized detections to.
    # Returns
...
def evaluate(
    ...
    # Arguments
        ...
        max_detections  : The maximum number of detections to use per image.
        save_path       : The path to save image_process with visualized detections to.
    # Returns
